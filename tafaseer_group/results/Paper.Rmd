---
# Hey Gang! This is an RNotebook intended to be used with RStudio an'it be fly stuff!
# ====================================================================================
# For documentation, check out these links:
# - https://www.rstudio.com/wp-content/uploads/2016/03/rmarkdown-cheatsheet-2.0.pdf
# - http://rmarkdown.rstudio.com/r_notebooks.html (a bit more explanatory)
# - http://rmarkdown.rstudio.com/lesson-1.html (RNotebook is a superset of RMarkdown)
# - https://blog.rstudio.org/2016/10/05/r-notebooks/ (some advanced examples)
# - https://rmflight.github.io/posts/2012/10/papersinRmd.html (comment by a scientist-user)
...
author: "F. Blunck, S. Bukhari, T. D. Keppen, J. R. Schmid"
output:
  pdf_document:
    toc: yes
  html_notebook:
...
# ====================================================================================
# Title (above) and outline (below) are just a first draft, please burn and rearrange!
---
...
Yo, extraction was simple like tha':
...
files.each do |f|
  # This is actual code and is actually run
  # when compiling the document, so I can't
  # write things that'll break it.
  puts "#{f}: f.download_it_from_the_internets"
  puts "#{f}: f.do_cool_stuff_to_it"
  puts "#{f}: f.save_as_csv"
end
```
